...
const reviewSteps = [
  ...
  { icon: MessageSquareText, title: 'Feedback tied to experiences', text: 'Traveler reviews are limited to completed LocalLink experiences.' },
];
      ...
      <div className="container verification-layout">
        ...
        <aside className="verification-profile" aria-label="Example reviewed guide profile">
          <div className="verification-profile-head">
            <Image src="/images/guides/linh.webp" width={72} height={72} style={{ width: 72, height: 72 }} alt="Linh, a reviewed LocalLink guide" />
          ...
          <p className="verification-support">LocalLink support is available before and during your experience.</p>
        </aside>
      </div>
    </section>
  );
