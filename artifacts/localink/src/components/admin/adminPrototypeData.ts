...
export const ADMIN_BOOKINGS: readonly AdminBooking[] = [
  ...
  { id: 'FLT-GUIDE001-20260615', travelerName: 'Alex T.', guideName: 'Linh N.', partnerSource: 'Saigon Riverside Hotel', date: '2026-06-15', subtotal: 72, travelerServiceFee: 3.6, total: 75.6, guidePlatformFee: 7.2, status: 'completed', paymentStatus: 'successful-demo', reviewStatus: 'submitted', flagged: false, currency: 'USD' },
  { id: 'FLT-GUIDE003-20260622', travelerName: 'Alex T.', guideName: 'Yuki P.', partnerSource: 'Saigon Riverside Hotel', date: '2026-06-22', subtotal: 60, travelerServiceFee: 3, total: 63, guidePlatformFee: 6, status: 'completed', paymentStatus: 'successful-demo', reviewStatus: 'submitted', flagged: false, currency: 'USD' },
  { id: 'FLT-GUIDE005-20260701', travelerName: 'Alex T.', guideName: 'Bảo V.', date: '2026-07-01', subtotal: 150, travelerServiceFee: 7.5, total: 157.5, guidePlatformFee: 15, status: 'completed', paymentStatus: 'successful-demo', reviewStatus: 'flagged-demo', flagged: true, currency: 'USD' },
  { id: 'FLT-GUIDE002-20260710', travelerName: 'Alex T.', guideName: 'Minh T.', partnerSource: 'Saigon Riverside Hotel', date: '2026-07-10', subtotal: 66, travelerServiceFee: 3.3, total: 69.3, guidePlatformFee: 6.6, status: 'cancelled', paymentStatus: 'refunded-demo', reviewStatus: 'not-submitted', flagged: false, currency: 'USD' },
