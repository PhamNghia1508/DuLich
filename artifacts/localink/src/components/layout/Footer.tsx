      ...
      <div className="container">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            <h4 className="footer-heading">For Travelers</h4>
            <nav className="footer-links">
              <Link href="/guides">Find a Guide</Link>
              <Link href="/#how-it-works">How It Works</Link>
              <Link href="/#safety">Safety & Trust</Link>
              <Link href="/guides?tab=experiences">Popular Experiences</Link>
            </nav>
          </div>

          {/* Column 3: Guides */}
          <div className="footer-col">
            <h4 className="footer-heading">For Local Guides</h4>
            <nav className="footer-links">
              <Link href="/guide-dashboard">Become a Guide</Link>
              <Link href="/guide-dashboard">Guide Dashboard</Link>
              <Link href="/guide-dashboard">Earnings & Payouts</Link>
              <Link href="/guide-dashboard">Guide Community</Link>
            </nav>
          </div>

          {/* Column 4: Contact & Settings */}
          <div className="footer-col">
            <h4 className="footer-heading">Contact & Language</h4>
            <div className="footer-contact">
              <div>
                <Mail size={14} />
                <a href="mailto:hello@localink.co">hello@localink.co</a>
              </div>
              <div>
                <MapPin size={14} />
