  ...
  const trustPoints = [
    {
      ...
      desc: 'The profile content and details are reviewed by the FriendLocalTrip community team.',
    },
    {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
        ...
        <div className="space-y-4 bg-[#FAFAF7] border border-[#E8E4DC] p-5 rounded-2xl">
          ...
          <div className="border-t border-[#E8E4DC] pt-3 mt-3 flex gap-2 text-[11px] text-[#5A5A5A] leading-relaxed">
            ...
            <p>
              FriendLocalTrip reviews profile information and displays relevant credentials supplied by the guide. Travelers should review all booking details before confirming.
            </p>
          </div>
        </div>
      </div>
